  ...
  return (
        <div className="flex flex-wrap my-4 w-full px-4">
          <div className="w-full px-4 ">
            <div className="relative mx-auto max-w-[525px] border-solid border-4  rounded-lg bg-white px-10 py-16 text-center sm:px-12 md:px-[60px]">
              ...
              <form onsubmit="">
                ...
                <div className="mb-10">
                  <input type="submit" value="Sign In" className="w-full rounded-md  px-5 py-3 bg-slate-600 font-medium text-white transition hover:bg-opacity-90"/>
                </div>
              </form>
              <p className="mb-6">Connect With</p>
              <ul className="-mx-2 mb-12 flex justify-between">
                <li className="w-full px-2">
                  <Link to="/" className="flex h-11 items-center justify-center rounded-md bg-slate-600 hover:bg-opacity-90">
                ...
                <li className="w-full px-2">
                  <Link to="/" className="flex h-11 items-center justify-center rounded-md bg-[#1C9CEA] hover:bg-opacity-90">
                ...
                <li className="w-full px-2">
                  <Link to="/" className="flex h-11 items-center justify-center rounded-md bg-[#d64937] hover:bg-opacity-90" >
              ...
              <Link to="/" className="mb-2 inline-block hover:text-primary hover:underline  "> Forget Password? </Link>
